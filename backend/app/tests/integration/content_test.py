...
class ContentIntegrationTestCase(BaseTestCase):
    ...
    def test_get_all_contents(self):
        ...
        with self.app.app_context():
            content1 = Content(
                id=str(uuid4()), title="Content 1", content="This is the first content."
            )
            content2 = Content(
                id=str(uuid4()),
                title="Content 2",
    ...
    def test_create_content_as_regular_user(self):
        ...
        response = self.client.post(
            "/contents",
            headers=headers,
            json={"title": "Unauthorized Content", "content": "Should not be allowed."},
        )
    ...
    def test_update_content_as_regular_user(self):
        ...
        response = self.client.put(
            f"/contents/{content_id}",
            headers=headers,
            json={"title": "Attempted Update", "content": "This update should fail."},
        )
        self.assertEqual(response.status_code, 403)
